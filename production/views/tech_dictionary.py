...
from production.models import DetailInGoods, Recipe, RecipeDetail, IMM, RecipeColorScheme
...
def tech_dictionary(request):
    ...
    recipe_color_scheme = RecipeColorScheme.objects.filter(deleted=False).order_by('color_scheme')
